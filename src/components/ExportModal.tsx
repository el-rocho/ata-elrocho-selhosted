    ...
    reader.onload = (event) => {
      ...
      if (text) {
        ...
        if (parsed.length === 0) {
          ...
          setImportStatus(`¡Éxito! Se han procesado e importado ${parsed.length} registros en el servidor.`);
        }
      }
    };
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-tabs">
          ...
          >
            Importar Copia CSV al Servidor
          </button>
        </div>
            ...
            <div className="import-tab-content">
              <div className="import-dropzone" onClick={() => fileInputRef.current?.click()}>
                ...
                <p className="dropzone-sub">
                  Importa registros CSV al servidor centralizado
                </p>
                <input
                  type="file"
                  ref={fileInputRef}

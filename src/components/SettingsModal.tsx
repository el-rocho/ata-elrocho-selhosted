    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          {/* Opción 5: Gestionar Registros del Servidor */}
          <div className="settings-section border-top">
            <div className="settings-row-header">
              <div>
                <h4 style={{ fontSize: '13px', margin: 0 }}>Base de Datos del Servidor</h4>
                <p className="settings-desc">Restaura datos de demostración o vacía el historial centralizado.</p>
              </div>
              ...
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                ...
                >
                  <Trash2 size={14} />
                  <span>Eliminar Datos Servidor</span>
                </button>
              </div>
            </div>
          </div>
